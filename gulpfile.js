...
require('gulp').task('mocha_tests', require('gulp-jsx-coverage').createTask({
    src: ['assets/app/test/**/*.js'],  // will pass to gulp.src as mocha tests 'test/components/_404.test.js'
