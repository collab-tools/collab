...
/***/ function(module, exports, __webpack_require__) {
	...
	var MilestoneRow = React.createClass({displayName: "MilestoneRow",
	    render: function() {
	        return (React.createElement("tr", null, React.createElement("th", {colSpan: "3"}, this.props.milestone)));
	    }
	});

	var CompletedRow = React.createClass({displayName: "CompletedRow",
	    render: function() {
	        return (React.createElement("tr", null, React.createElement("td", {className: "completed", colSpan: "3"}, this.props.count, " completed")));
	    }
	});
	    ...
	    render: function () {
	        ...
	        return (
	            React.createElement("tr", null, 
	                React.createElement("td", {width: "5"}, React.createElement("input", {type: "checkbox"})), 
	    ...
	    render: function() {
	        ...
	        this.props.taskList.forEach(function(task) {
	            ...
	            if (task.milestone !== lastMilestone) {
	                if (completedTasks > 0) {
	                    rows.push(React.createElement(CompletedRow, {count: completedTasks, key: getKey()}));
	                    completedTasks = 0;
	                }
	                rows.push(React.createElement(MilestoneRow, {milestone: task.milestone, key: getKey()}));
	            }

	            if (task.completedDate === null) {
	                rows.push(React.createElement(TaskRow, {task: task, key: getKey()}));
	            } else {
	                completedTasks++;
	            }
	...
	$(window).bind("load", function() {
	    React.render(React.createElement(TaskTable, {taskList: TASKS}), document.getElementById('task-panel'));
	});
